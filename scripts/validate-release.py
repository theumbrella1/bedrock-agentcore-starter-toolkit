...
def main():
    ...
    print(f"Repository: bedrock-agentcore-starter-toolkit-staging")
    ...
    print(f"\nNext steps:")
    print(f"1. Update pyproject.toml to use staging dependencies")
    print(f"2. Test on Test PyPI: Follow instructions in MCM document")
